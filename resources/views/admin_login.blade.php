...
<body class="login-page" background="{{ asset('backend/images/background2.jpg')}}">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Admin<b>SaiGonHome</b></a>
            <small>Logo</small>
        </div>
        <div class="card">
            <div class="body">
                <h2><center><span style="color: red"> <?php
                            ...
                            ?></span></center> </h2>
            <h2>Đăng nhập  </h2>
                <form id="sign_in" action="{{ URL::to('/login-admin') }}" method="get">
                    {{ csrf_field()}}
